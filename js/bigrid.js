    ...
    $.init_biGrid = function(table, property){
        ...
        var grid = {
            ...
            prepareScroll : function() {
                ...
                var scrollbarHorizon = "<div class='gScrollbarHorizon' onselectstart='return false'><img class='gScrollbarBtnLeft' src='" + property.imagefolder + "css//skin/default/images/sl.gif' /><img class='gScrollbarBtnRight' src='" + property.imagefolder + "css//skin/default/images/sr.gif' /></div><table border=0 cellpadding=0 cellspacing=0 class='gScrollbarHorizonItem' onselectstart='return false'><tr><td align='left'><img src='" + property.imagefolder + "css//skin/default/images/sh_left.gif' /></td><td align='right'><img src='" + property.imagefolder + "css//skin/default/images/sh_right.gif' /></td></tr></table>";
                var scrollbarVertical = "<div class='gScrollbarVertical' onselectstart='return false'><img class='gScrollbarBtnUp' src='" + property.imagefolder + "css//skin/default/images/su.gif' /><img class='gScrollbarBtnDown' src='" + property.imagefolder + "css//skin/default/images/sd.gif' /></div><table border=0 cellpadding=0 cellspacing=0 class='gScrollbarVerticalItem' onselectstart='return false'><tr><td valign='top'><img src='" + property.imagefolder + "css//skin/default/images/sv_up.gif' /></td></tr><tr><td valign='bottom'><img src='" + property.imagefolder + "css//skin/default/images/sv_down.gif' /></td></tr></table>";
