							...
							<tfoot>
								<tr class="label" id="data-source">
								   ...
								   <select id="classcodes" class="small">
									...
									<td class="small head">
								   <input type="text" class="small" id="item_header" />
									</td>
									<td class="large head">
									 <input type="text" class="large" id="item-desc" />
									</td>
									<td class="small head">
									 <input type="text" class="small" id="items"/>
									</td>
									<td class="small head">
									 <input type="text" class="small" id="base" />
									</td>
									<td class="mini noborder">
